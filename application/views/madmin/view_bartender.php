        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
            <form role="form" method="post"
               ...
               <div class="row input-container">
                ...
                <div class="row">
                <?php 
                    $school = json_decode($edit_data['school_education']);
                    foreach($school as $key=>$dt){
                ?>
                    <div class="col-md-6">
                        <label class="">&nbsp;&nbsp;&nbsp;&nbsp;<?= get_phrase("school_education") ?></label>
                        <div class="col-md-12">
                            <input type="text"
                               placeholder="xxxxx高中"
                ...
                <?php 
                    $year = json_decode($edit_data['year_education']);
                ?>
                    <div class="col-md-6">
                        <label class="">&nbsp;&nbsp;&nbsp;&nbsp;<?= get_phrase("year_education") ?></label>
                        <div class="col-md-12">
                            <input type="text"
                               placeholder="MM/YYYY"
                               name="year_education[]"
                               value="<?php echo $year[$key];?>"
                               class="form-control" required>
                        </div>
                    </div>
                <?php } ?>
                 ...
                 <div class="row">
                <?php 
                    $bar = json_decode($edit_data['bar_work_1']);
                    foreach($bar as $key=>$dt){
                ?>
                    <div class="col-md-6">
                        <label class="">&nbsp;&nbsp;&nbsp;&nbsp;<?= get_phrase("bar_work_1") ?></label>
                        <div class="col-md-12">
                            <input type="text"
                               placeholder="调酒师"
                               name="bar_work[]"
                ...
                <?php 
                    $position = json_decode($edit_data['position_work_1']);
                ?>
                    <div class="col-md-6">
                        <label class="">&nbsp;&nbsp;&nbsp;&nbsp;<?= get_phrase("position_work_1") ?></label>
                        <div class="col-md-12">
                            <input type="text"
                               placeholder="2020-至今"
                               name="position_work[]"
                               value="<?php echo $position[$key]; ?>"
                               class="form-control" required>
                        </div>
                    </div>
                <?php } ?>
